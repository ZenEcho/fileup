<template>
    <div>
        <svg style="width: 100vw;height: 100vh;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            <defs>
            ...
            <g id="freepik--Clouds--inject-14">
                <path class="cloud1" d="M364.45,158.35a10.35,10.35,0,0,0-20.1,0Z"
                    style="fill:none;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.1930027515339008px" />
                <path class="cloud1"
            ...
            <g id="freepik--Character--inject-14">
                ...
                <path d="M183,290.25s3.75,2.6,4.08,4.43-4.16,7-9.15,8.16-7.66-1.67-6.16-4.33S179.22,290.49,183,290.25Z"
                    style="fill:#92E3A9;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.1930027515339008px" />
                <path class="line" d="M337,266.56V131.27s-2.73,9.79-2.73,10.5"
                    style="fill:none;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.1930027515339008px" />
                <g class="card">
